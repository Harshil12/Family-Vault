...
/// <summary>
/// Represents UpdateBankAccountValidators.
/// </summary>
public class UpdateBankAccountValidators : AbstractValidator<UpdateBankAccountRequest>
{
    /// <summary>
    /// Initializes a new instance of UpdateBankAccountValidators.
    /// </summary>
    public UpdateBankAccountValidators()
    {
        RuleFor(x => x.Id)
